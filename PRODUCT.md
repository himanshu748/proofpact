...
web
## Users
Clients commissioning small software projects, freelance builders, and hackathon reviewers trying the synthetic demo.
## Product Purpose
Agree on measurable scope, price and deadlines; retain dual human authority; independently inspect a delivered app.
## Positioning
Two private advocates, one shared immutable agreement, and criterion-level browser evidence.
## Operating Context
...
## Evidence on Hand
Synthetic Acme Admin Portal agreement: INR 7,500, September 21, four deliverables, five criteria. A broken fixture exports 10 of 27 records; a repaired one exports 27. Do not fabricate customers, testimonials or completion claims.
## Product Principles
Humans hold authority. Private constraints stay structurally separate. Evidence beats confidence. Uncertainty is a valid result.
## Accessibility & Inclusion
Keyboard access, visible focus, readable contrast, reduced motion, 390px mobile layout.
